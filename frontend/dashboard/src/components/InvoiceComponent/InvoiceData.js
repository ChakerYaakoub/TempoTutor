...
const InvoiceData = ({ data }) => {
    ...
    return (
        <div className='InvoiceComponent'>
            ...
            <div class=" logo-containerInvoiceSection items-center inline-flex mb-6 text-3xl font-bold text-gray-900 dark:text-white">

                {/* <img src={appIcon} style={{ background :currentColor }}  alt="logo" className='w-8 rounded-full rounded-l-xl rounded-r  ' /> */}


                <MySVGComponent  />
                <span >Tempo<span  className=' dark:text-white'>Tutor</span> </span>
